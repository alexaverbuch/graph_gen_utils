...
public class MetricsWriterUndirected {
  ...
  public static void writeMetrics(GraphDatabaseService transNeo,
    ...
    try {
      ...
      bufferedWriter.write(String.format("\tNodes:\t\t\t%d", metricsReader
        .nodeCount()));
      bufferedWriter.newLine();
      
      bufferedWriter.write(String.format("\tEdges:\t\t\t%d", metricsReader
        .edgeCount()));
      bufferedWriter.newLine();
      
      bufferedWriter.write(String.format("\tClustering Coefficient:\t\t%f",
        metricsReader.clusteringCoefficient()));
      bufferedWriter.newLine();
      
      bufferedWriter.write(String.format("***Clustering Metrics***"));
      bufferedWriter.newLine();
      
      bufferedWriter.write(String.format("\tEdge Cut:\t\t%d:", metricsReader
        .edgeCut()));
      bufferedWriter
        .write(String.format("\t\t%f", metricsReader.edgeCutPerc()));
      bufferedWriter.newLine();
      
      bufferedWriter.write(String.format("\tCluster Size Variation:\t%d:",
        metricsReader.clusterSizeDiff()));
      ...
      bufferedWriter.write(String.format("\tModularity:\t\t%f", metricsReader
        .modularity()));
      bufferedWriter.newLine();
  ...
  public static void writeMetricsCSV(GraphDatabaseService transNeo,
    ...
    try {
      ...
      bufferedWriter.write(String.format("Nodes,Edges,ClusteringCoefficient"));
      bufferedWriter.newLine();
      
      bufferedWriter.write(String.format("%d,%d,%f", metricsReader.nodeCount(),
        metricsReader.edgeCount(), metricsReader.clusteringCoefficient()));
      bufferedWriter.newLine();
      ...
      bufferedWriter.write(String.format("%s,%d,%f,%d,%d,%f,%d,%d,%d,%f,%s",
        timeStepStr, metricsReader.edgeCut(), metricsReader.edgeCutPerc(),
        metricsReader.clusterCount(), metricsReader.clusterSizeDiff(),
        metricsReader.clusterSizeDiffPerc(), metricsReader.meanClusterSize(),
        metricsReader.minClusterSize(), metricsReader.maxClusterSize(),
        metricsReader.modularity(), metricsReader.clustersToString()));
      bufferedWriter.newLine();
  ...
  public static void appendMetricsCSV(GraphDatabaseService transNeo,
    ...
    try {
      ...
      bufferedWriter = new BufferedWriter(new FileWriter(metricsFile, true));
